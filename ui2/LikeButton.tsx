...
export default function LikeButton({
 ...
 const likeSVG = (
  ...
  return (
        <Button onClick={handleToggle} className={`inline-flex items-center gap-2 text-sm transition-colors hover:text-red-500 disabled:opacity-50 disabled:cursor-not-allowed ${
